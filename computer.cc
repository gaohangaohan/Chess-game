...
#include "piece.h"
#include "board.h"
LevelFour::LevelFour(Board *pb, int i): Player(pb, i) {}
LevelFour::~LevelFour() {}
void LevelFour::move() {
            ...
            for(char c2 = 'a'; c2<= 'h'; ++c2) {
                for(int n2 = 1; n2 <= 8; ++n2) {
                    ...
                    if(this->valid(pb, c1, n1, c2, n2)) {
                        bool b1 = false;
                        if(pb->vb[(8 - n2) * 8 + c2 - 'a'].getType() == 'Q') {b1 = true;}
                        int ls = (8 - n1) * 8 + c1 -'a';
                        Board b = *pb;
                        char nck = ck;
                        int nik = ik;
                        ...
                        if (b.isAttacked(color, ck, ik) || !b1) {
                            ck = nck;
                            ik = nik;
                            throw Invalid {};
                        } else {
...
Level::Level(Board *pb, int i): Player(pb, i) {}
Level::~Level() {}
void Level::move() {
    if (this->isCheck()) {pb->init();}
    for(char c1 = 'a'; c1 <= 'h'; ++c1) {
        for(int n1 = 1; n1 <= 8; ++n1) {
            for(char c2 = 'a'; c2<= 'h'; ++c2) {
                for(int n2 = 1; n2 <= 8; ++n2) {
